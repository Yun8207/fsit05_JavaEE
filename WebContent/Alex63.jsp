...
<jsp:useBean id="member1" class="tw.alex.beans.Member"/>
<jsp:useBean id="member2" class="tw.alex.beans.Member"/>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<c:set target="${member1}" property="name">Alex</c:set>
